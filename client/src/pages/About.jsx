  ...
  return (
    <div style={{ minHeight: '100vh', background: '#FFFFFF' }}>
      ...
      <section className="about-hero" style={{ 
        ...
        {/* Glow Background */}
        <div style={{ position: 'absolute', inset: 0, backgroundImage: 'radial-gradient(circle at 50% 50%, rgba(229,57,53,0.15) 0%, transparent 60%)' }} />
        
        <div className="max-w-4xl mx-auto px-4 relative z-10">
          <p style={{ color: '#E53935', fontSize: '0.9rem', fontWeight: 800, letterSpacing: '0.3em', textTransform: 'uppercase', marginBottom: '1rem' }}>Our Story</p>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="stats-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '2rem', textAlign: 'center' }}>
            {[
              ...
              { value: '500+', label: 'Certified Bikes', icon: Award },
              { value: '60 Min', label: 'Service Promise', icon: Clock },
            ].map((stat, i) => (
              <div key={i} style={{ padding: '1rem' }}>
                <stat.icon size={28} style={{ color: '#E53935', marginBottom: '0.8rem' }} />
      ...
      <section style={{ padding: '6rem 0', background: '#F9F9F9' }}>
        <div className="max-w-6xl mx-auto px-4">
          <div className="journey-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(400px, 1fr))', gap: '4rem', alignItems: 'center' }}>
            <div>
              <div style={{ width: 40, height: 4, background: '#E53935', marginBottom: '1.5rem', borderRadius: '2px' }} />
              ...
              <div className="journey-subgrid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem' }}>
                <div style={{ background: '#FFF', padding: '1.5rem', borderRadius: '16px', border: '1px solid #EEE', boxShadow: '0 4px 15px rgba(0,0,0,0.03)' }}>
                  <Zap size={22} style={{ color: '#E53935', marginBottom: '0.8rem' }} />
                  <h4 style={{ color: '#111', fontWeight: 800 }}>Fast Valuation</h4>
                  <p style={{ color: '#777', fontSize: '0.85rem' }}>Selling your bike? Get an AI-driven quote in seconds.</p>
                </div>
                <div style={{ background: '#FFF', padding: '1.5rem', borderRadius: '16px', border: '1px solid #EEE', boxShadow: '0 4px 15px rgba(0,0,0,0.03)' }}>
                  <Shield size={22} style={{ color: '#E53935', marginBottom: '0.8rem' }} />
                  <h4 style={{ color: '#111', fontWeight: 800 }}>Certified Quality</h4>
                  <p style={{ color: '#777', fontSize: '0.85rem' }}>Every bike undergoes a rigorous 150-point inspection.</p>
                </div>
              </div>
            </div>
      ...
      <section style={{ padding: '6rem 0', background: '#FFF' }}>
        <div className="max-w-6xl mx-auto px-4">
          <div style={{ textAlign: 'center', marginBottom: '4rem' }}>
            <h2 style={{ fontFamily: 'Rajdhani, sans-serif', fontSize: '2.5rem', fontWeight: 900, color: '#111' }}>OUR CORE <span style={{ color: '#E53935' }}>VALUES</span></h2>
              ...
              onMouseLeave={e => { 
                ...
                <div className="value-card-content" style={{ padding: '2rem', position: 'relative' }}>
                  <div style={{ 
                    ...
                    justifyContent: 'center', boxShadow: '0 8px 20px rgba(229,57,53,0.3)',
